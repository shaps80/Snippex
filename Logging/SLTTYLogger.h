...
@interface SLTTYLogger : SLAbstractLogger <SLLogger>
{
	NSCalendar *calendar;
...
/* Inherited from the SLLogger protocol:
 * 
 ...
 * 
 * The actual implementation of these methods is inherited from SLAbstractLogger.
 ...
 * 
 * If you run the application from a shell, then SLTTYLogger will automatically map the given color to
...
/**
 * Similar to the methods above, but allows you to map SLLogMessage->tag to a particular color profile.
 * For example, you could do something like this:
 * 
 * static NSString *const PurpleTag = @"PurpleTag";
 * 
 * #define SLLogPurple(frmt, ...) LOG_OBJC_TAG_MACRO(NO, 0, 0, 0, PurpleTag, frmt, ##__VA_ARGS__)
 * 
 ...
 * 
 * [[SLTTYLogger sharedInstance] setForegroundColor:purple backgroundColor:nil forTag:PurpleTag];
 * [SLLog addLogger:[SLTTYLogger sharedInstance]];
 * 
 * This would essentially give you a straight NSLog replacement that prints in purple:
 * 
 * SLLogPurple(@"I'm a purple log message!");
**/
#if TARGET_OS_IPHONE
